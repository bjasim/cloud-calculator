...
class ComputeSpecificationsAdmin(admin.ModelAdmin):
    list_display = ( 'name', 'price_monthly', 'region' ,'unit_price', 'cpu', 'memory' , 'sku' ,'provider', 'cloud_service',)
...
class StorageSpecificationsAdmin(admin.ModelAdmin):
    list_display = ( 'name', 'price_monthly', 'region' ,'unit_price', 'unit_of_storage' ,'sku' ,'provider', 'cloud_service',)
    list_display_links = ('name',)  # Make the name field clickable

admin.site.register(StorageSpecifications, StorageSpecificationsAdmin)

class NetworkingSpecificationsAdmin(admin.ModelAdmin):
    list_display = ( 'name', 'price_monthly', 'region' ,'unit_price', 'unit_of_measure' ,'sku' ,'provider', 'cloud_service',)
    list_display_links = ('name',)  # Make the name field clickable
...
class DatabaseSpecificationsAdmin(admin.ModelAdmin):
    list_display = ( 'name', 'price_monthly','region' ,'unit_price', 'unit_of_storage', 'sku' , 'data_type' ,'provider', 'cloud_service',)
    list_display_links = ('name',)  # Make the name field clickable
